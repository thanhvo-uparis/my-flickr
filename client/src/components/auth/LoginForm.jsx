...
const LoginForm = () => {
    ...
    const onPasswordChange = event => setLoginForm({...loginForm, password: event.target.value});
    ...
    return (
        <div className="w-full max-w-xs">
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <input id="username" type="text" placeholder="Username" value={loginForm.username} onChange={onUsernameChange} class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"/>
                </div>
                ...
                <input id="password" type="password" value={loginForm.password} onChange={onPasswordChange} class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"/>
